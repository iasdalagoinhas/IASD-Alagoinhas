...
FALLBACK_DISTRICTS = {
    ...
    "21 de Setembro": {
        ...
        "teams": copy.deepcopy(DEFAULT_TEAMS),
        "churches": [
            {"name": "Igreja Adventista 21 de Setembro", "type": "Igreja", "location": "21 de Setembro — Alagoinhas/BA", "responsible": "Pr. Josimar Martins", "central": True, "schedule": {}, "ja": [], "special": []},
...
def render_membros_page():
    ...
    # Busca objeto da igreja do membro
    church_obj = None
    ...
    tab_lider, tab_comissao, tab_tesouraria, tab_aprovacao, tab_senha = st.tabs([
        "👥 Liderança da Igreja",
        "📅 Reunião de Comissão",
